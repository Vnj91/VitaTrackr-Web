...
export default function HeroSection() {
  ...
  return (
    <section className="py-12 relative overflow-visible">
      ...
      <motion.div aria-hidden initial={{ opacity: 0.6 }} animate={{ opacity: 0.9 }} transition={{ duration: 6, repeat: Infinity, repeatType: 'reverse' }} className="absolute -top-10 left-1/2 -translate-x-1/2 -z-10 w-[90%] max-w-4xl">
      ...
      <motion.div initial="hidden" animate="show" variants={container} className="text-center max-w-4xl mx-auto">
        ...
        <motion.div variants={item} className="mb-6">
          <button className="bg-indigo-600 text-white px-6 py-3 rounded-lg shadow-lg hover:scale-105 transition-transform">Get Started</button>
        </motion.div>
