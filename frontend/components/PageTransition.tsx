  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div key={pathname} initial="initial" animate="enter" exit="exit" variants={variants} className="relative overflow-hidden">
        ...
        <motion.div aria-hidden className="pointer-events-none absolute inset-0 -z-10 opacity-40" initial={{ scale: 0.95 }} animate={{ scale: 1.02 }} transition={{ duration: 8, yoyo: Infinity, ease: 'linear' }}>
